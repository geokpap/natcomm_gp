function result = lfp_findNegThresh3(filenum, thresh, option)
%lfp_findNegThresh3 for lfp_createEvents finds positive-going threshold
% crossings
%result = lfp_findNegThresh3(filenum, thresh)
%result = lfp_findNegThresh3(filenum, thresh, 'sample')
