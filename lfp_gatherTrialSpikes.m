function [spikes, triginfo, evtidx, evtmatrix, noreftrialidx] = ...
    lfp_gatherTrialSpikes(trials, clustnums, window, varargin)
...
% constructing it.  See lfp_getSamples and lfp_gatherTrialData for
% discrete-time CSC data.
%INPUTS
...
%$Rev: 306 $
%$Date: 2013-09-09 14:37:17 -0400 (Mon, 09 Sep 2013) $
%$Author: dgibson $
