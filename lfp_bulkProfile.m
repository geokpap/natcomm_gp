function lfp_bulkProfile(funcH, argvals, varargin)
%BULKPROFILE performs offline processing on a list of
%argument values (e.g. directories).  Same as lfp_bulkProcess, except with
%profiling enabled and results saved to "STATS.mat".
% lfp_bulkProfile(funcH, argvals)
...
while argnum <= length(varargin)
    switch varargin{argnum}
        case 'debug'
            debugflag = true;
        otherwise
            error('lfp_bulkProfile:badoption', ...
