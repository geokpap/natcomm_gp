...
%       new figure, specify a new figure number, or specify 0 to
%       let Matlab choose a figure number.
...
%$Rev: 202 $
%$Date: 2011-02-01 20:11:48 -0500 (Tue, 01 Feb 2011) $
%$Author: dgibson $
...
%                 lfp_plotEvtMarkers(hA, evtmatrix, varargin);
            else
                ...
                switch option
                    case 'ovr'
                        ...
                        if isfield(axesinfo, 'trialnums')
                            ...
                            trials2plot = lfp_enabledTrials(1:length(...
                                lfp_SelectedTrials ));
                        end
...
%                         lfp_plotEvtMarkers(hA, evtmatrix, varargin);
                    case 'errorcurves'
                        ...
                        if dBflag
                            plot(xscale, ...
                                10*log10(sampledata(:,channel,1)'), 'k');
                            plot(xscale, ...
...
if ~isempty(axesinfo.ylim) && isequal(size(axesinfo.ylim), [1 2]) ...
