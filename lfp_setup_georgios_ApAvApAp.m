...
lfp_SetupType = 'georgios_ApAvApAp';
lfp_TrialStyle = 'rule';
lfp_AlignStyle = 'name';
...
lfp_EventNames{RWD_OFF_FORCEDRedApAp} = 'RWD_OFF_FORCEDRedApAp';
lfp_EventNames{RWD_OFF_FORCEDYelApAp} = 'RWD_OFF_FORCEDYelApAp';
...
lfp_EventNames{crossOffRedApAp} = 'crossOffRedApAp';
...
lfp_EventNames{forcedRedOffApAp} = 'forcedRedOffApAp';
lfp_EventNames{forcedRedOn} = 'forcedRedOn';
lfp_EventNames{forcedRedOnApAp} = 'forcedRedOnApAp';
lfp_EventNames{forcedYelOff} = 'forcedYelOff';
lfp_EventNames{forcedYelOffApAp} = 'forcedYelOffApAp';
lfp_EventNames{forcedYelOn} = 'forcedYelOn';
lfp_EventNames{forcedYelOnApAp} = 'forcedYelOnApAp';
...
lfp_EventNames{targetsOnApAp} = 'targetsOnApAp';
