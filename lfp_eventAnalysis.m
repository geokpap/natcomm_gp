...
% last event.  WARNING:  TERRA REPORTS THAT THIS ALGORITHM DOES NOT WORK
% WELL FOR MANY SESSIONS!  ALWAYS CHECK THE RESULTS!
...
%$Rev: 83 $
%$Date: 2009-10-06 19:31:00 -0400 (Tue, 06 Oct 2009) $
%$Author: dgibson $
...
if repairevts
    if repairevts == 1
        ...
        warning('lfp_eventAnalysis:repairevts1', ...
            'INTERPOLATED EVENTS SHOULD BE VERIFIED ON A SESSION-BY-SESSION BASIS');
        badtrialoutcomeidx = [];
    ...
    if repairevts == 2 || ~isempty(badtrialoutcomeidx) || ...
        ...
        % substTS{evtidx} still contains the interpolated timestamps
